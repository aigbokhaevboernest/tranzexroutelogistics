    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
          ...
          <div>
            <div style={{ fontSize: "18px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "1px" }}>{company.name}</div>
      ...
      <div style={{ textAlign: "center", marginBottom: "28px" }}>
        ...
        <div style={{ marginTop: "8px", display: "inline-flex", gap: "10px", alignItems: "center", flexWrap: "wrap", justifyContent: "center" }}>
          ...
          {s?.current_location && (
            <span style={{ fontSize: "11px", color: "#555" }}>📍 {s.current_location}</span>
          )}
        </div>
      </div>
